...
public class AskForMovies extends AsyncTask<String, Void, ArrayList<Movie>> {

    private final String LOG_TAG = AskForMovies.class.getSimpleName();
    ...
    public AskForMovies(Context context, ArrayList<Movie> movies,
                        AdapterGridMovies mMoviePosterAdapter, String sortBy){
    ...
    protected ArrayList<Movie> doInBackground(String... params) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(KEY,API_Key.API_KEY)
                    .build();
